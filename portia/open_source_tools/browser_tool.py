...
required, the tool will return an ActionClarificationWithUserConfirmation with the user guidance
and login URL. If authentication is not required, the tool will return the task output. It uses
