...
from portia.plan_v1_backup import Plan as PlanV1
from portia.plan_v1_backup import PlanContext, PlanInput
...
class Plan(BaseModel):
    ...
    def to_legacy_plan(self, plan_context: PlanContext) -> PlanV1:
        """Convert this plan to the legacy Plan format.

        This method enables backward compatibility with systems that still use the
        original plan representation. It transforms each Step into its legacy
