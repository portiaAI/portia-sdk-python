...
def test_portia_run_query_with_example_registry_and_hooks() -> None:
    ...
    execution_hooks = ExecutionHooks(
        before_first_execution_step=MagicMock(return_value=None),
        before_execution_step=MagicMock(return_value=None),
        after_execution_step=MagicMock(return_value=None),
        after_last_execution_step=MagicMock(return_value=None),
