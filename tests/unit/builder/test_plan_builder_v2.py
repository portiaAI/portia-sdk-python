...
def test_exit_method_basic_usage() -> None:
...
def test_exit_method_with_error_flag() -> None:
...
def test_exit_method_with_custom_step_name() -> None:
...
def test_exit_method_with_empty_message() -> None:
...
def test_exit_method_with_message_references() -> None:
...
def test_exit_method_chaining() -> None:
...
def test_exit_method_within_conditional_block() -> None:
    """Test exit() method within a conditional block."""
    builder = PlanBuilderV2()

    result = builder.if_(condition="test_condition").exit(message="Exit within conditional").endif()
...
def test_exit_method_within_nested_conditional_blocks() -> None:
...
def test_exit_method_after_other_steps() -> None:
...
def test_exit_method_with_complex_workflow() -> None:
...
def test_exit_method_error_handling_scenario() -> None:
...
def test_exit_method_early_completion_scenario() -> None:
