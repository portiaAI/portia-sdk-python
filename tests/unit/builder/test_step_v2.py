...
class TestExitStep:
    """Test cases for the ExitStep class."""

    def test_exit_step_initialization_defaults(self) -> None:
    ...
    def test_exit_step_initialization_with_custom_values(self) -> None:
    ...
    def test_exit_step_str_representation_no_error(self) -> None:
    ...
    def test_exit_step_str_representation_with_error(self) -> None:
    ...
    def test_exit_step_str_representation_no_message(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_exit_step_run_basic(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_exit_step_run_with_error(self) -> None:
    ...
    def test_exit_step_to_legacy_step_error_exit(self) -> None:
    ...
    def test_exit_step_to_legacy_step_no_message(self) -> None:
