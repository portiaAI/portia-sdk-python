...
async def test_async_aget_plan_run_request_exception(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_exception(
        method="GET",
        url=f"https://api.portialabs.ai/api/v0/plan-runs/{plan_run_id}/",
...
async def test_async_aget_plan_runs_request_exception(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_exception(
        method="GET",
        url="https://api.portialabs.ai/api/v0/plan-runs/?page=1&run_state=IN_PROGRESS",
        exception=httpx.ConnectError("Connection failed"),
    )
...
async def test_async_aget_end_user_request_exception(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_exception(
        method="GET",
        url=f"https://api.portialabs.ai/api/v0/end-user/{external_id}/",
        exception=httpx.ConnectError("Connection failed"),
    )
...
async def test_async_portia_cloud_storage(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_response(
        method="PUT",
        url=f"https://api.portialabs.ai/api/v0/plan-runs/{plan_run.id}/",
        status_code=500,
        content=b"An error occurred.",
    )
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://api.portialabs.ai/api/v0/plan-runs/?",
        status_code=500,
        content=b"An error occurred.",
    )
    ...
    httpx_mock.add_response(
        method="GET",
        url=f"https://api.portialabs.ai/api/v0/end-user/{end_user.external_id}/",
        status_code=500,
        content=b"An error occurred.",
    )
...
async def test_async_portia_cloud_storage_errors(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_exception(
        method="GET",
        url="https://api.portialabs.ai/api/v0/plan-runs/?page=10&run_state=COMPLETE",
        exception=RuntimeError("An error occurred."),
    )
...
async def test_async_portia_cloud_agent_memory_errors(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_response(
        method="PUT",
        url=f"https://api.portialabs.ai/api/v0/agent-memory/plan-runs/{plan_run.id}/outputs/too_large_output/",
...
async def test_async_plan_exists_portia_cloud_storage(httpx_mock: HTTPXMock) -> None:
    ...
    httpx_mock.add_response(
        method="GET",
        url=f"https://api.portialabs.ai/api/v0/plans/{different_plan_id}/",
        status_code=404,
        content=b"Not found",
    )
